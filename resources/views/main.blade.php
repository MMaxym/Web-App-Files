...
{{--                            </table>--}}
        ...
        {{--    // Отримуємо файл з input--}}
        {{--    const fileInput = document.getElementById('fileInput');--}}
        {{--    const file = fileInput.files[0];--}}

        {{--    // Перевірка на додавання файлу через інпут або перетягування--}}
        {{--    const uploadedFilesCount = document.getElementById('uploadedFiles').childElementCount;--}}

        {{--    // Якщо файл не вибраний в інпуті або перетягнутий в область--}}
        ...
        {{--        // Сховати помилку через 3 секунди--}}
        {{--        setTimeout(() => {--}}
